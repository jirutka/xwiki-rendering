...
/**
 * Generate a string representation of a Link reference, in Markdown syntax.
 * This implementation is pluggable by using internally implementations of 
 * {@link org.xwiki.rendering.renderer.reference.ResourceReferenceTypeSerializer}, each in charge of serializing a 
 * given {@link org.xwiki.rendering.listener.reference.ResourceType}.
 *
 * <p>
 * Note that {@link org.xwiki.rendering.renderer.reference.ResourceReferenceTypeSerializer} component implementations
 * must use a role hint equal to the Markdown id followed by "/" and then Link 
 * Type name (eg "doc" for document links, "attach" for attachment links, etc).
 * </p>
 * 
 * @version $Id $
 * @since 5.2M1
...
@Singleton
public class MarkdownLinkReferenceSerializer implements ResourceReferenceSerializer
{
    /**
     * Prefix to use for {@link org.xwiki.rendering.renderer.reference.ResourceReferenceTypeSerializer} role hints.
     */
    private static final String COMPONENT_PREFIX = "markdown/1.1";
    ...
    public String serialize(ResourceReference reference)
    {
        ...
        try {
            ...
            try {
                ...
                // Failed to find a default serializer for the current syntax. Use markdown/1.1 default serializer.
