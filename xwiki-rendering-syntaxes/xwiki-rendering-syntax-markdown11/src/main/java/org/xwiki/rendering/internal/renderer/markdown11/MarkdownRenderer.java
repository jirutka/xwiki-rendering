...
/**
 * Generates Markdown 1.1 from {@link org.xwiki.rendering.block.XDOM}.
 * 
 * @version $Id $
 * @since 5.2M1
 */
...
{
    /**
     * Component to serialize wiki link references.
     */
    @Inject
    ...
    /**
     * Component manager used to find out at runtime a link label generator matching the link reference type.
     */
    @Inject
    ...
    {
        ListenerChain chain = new MarkdownListenerChain();
        ...
        chain.addListener(new MarkdownBlockStateChainingListener(chain));
        chain.addListener(new MarkdownChainingRenderer(chain, linkReferenceSerializer, componentManager));
    }
}
