...
/**
 * Renders a {@link org.xwiki.rendering.block.Block} in Markdown 1.1.
 *
 * @version $Id $
 * @since 5.2M1
 */
...
public class MarkdownBlockRenderer extends AbstractBlockRenderer
{
    ...
    @Inject
    @Named("markdown/1.1")
    private PrintRendererFactory markdownSyntaxRendererFactory;

    @Override
    protected PrintRendererFactory getPrintRendererFactory()
    {
        return this.markdownSyntaxRendererFactory;
    }
}
